...
df <- df %>% 
        mutate(
                ...
                ## MIXED PRECIPITATION
                EVTYPE = case_when(EVTYPE %in% c("MIXED PRECIP",
                                                 "MIXED PRECIPITATION") ~ "MIXED PRECIPITATION"),
                ## RAIN
                EVTYPE = case_when(EVTYPE %in% c("TROPICAL STORM",
                ...
                EVTYPE = case_when(EVTYPE %in% c("COLD AIR TORNADO",
                                                 ...
                                                 "WHIRLWIND") ~ "TORNADO"),
                ## WATER SPROUT
                EVTYPE = case_when(EVTYPE %in% c("WATERSPOUT",
                                                 "WATERSPOUT-") ~"WATERSPOUT"),
                ## WILD FIRES
                EVTYPE = case_when(EVTYPE %in% c("WILD FIRES",
                                                 "WILD/FOREST FIRE",
                                                 "WILD/FOREST FIRES",
                                                 "WILDFIRE",
                                                 "WILDFIRES",
                ...
                ## WINTER STORM
                EVTYPE = case_when(EVTYPE %in% c("WINTER STORM",
                                                 "WINTER STORM HIGH WINDS",
                                                 "WINTER STORMS") ~ "WINTER STORM"),
                ## WINTER WEATHER
                EVTYPE = case_when(EVTYPE %in% c("WINTER WEATHER",
                                                 "WINTER WEATHER MIX",
                                                 "WINTER WEATHER/MIX",
